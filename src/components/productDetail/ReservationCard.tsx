			...
			<div className="h-min p-6 border rounded-lg sticky top-[200px]">
				...
				<div className="border rounded mb-4">
					...
					<div className="relative border-b p-4 cursor-pointer">
						<div onClick={handleToggleRoom} className="flex justify-between items-center">
							<div>
					...
					<div className="relative border-b p-4">
						<div onClick={handleToggleDate} className="flex justify-between items-center cursor-pointer">
					...
					<div className="relative p-4">
						<div onClick={handleToggleGuests} className="flex justify-between items-center cursor-pointer">
							<div>
